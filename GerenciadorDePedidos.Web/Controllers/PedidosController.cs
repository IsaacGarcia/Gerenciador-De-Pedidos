...
namespace GerenciadorDePedidos.Web.Controllers
{
    public class PedidosController : Controller
    {
        ...
        public ActionResult Create([Bind(Include="Id,Nome,DataDoCadastro")] Pedido pedido)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include="Id,Nome,DataDoCadastro")] Pedido pedido)
        {
            if (ModelState.IsValid)
            {
